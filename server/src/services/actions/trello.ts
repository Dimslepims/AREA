        ...
        let job = new CronJob('*/10 * * * * *', async () => {
            if (this.state === false)
                ...
                try {
                    ...
                    if (this.lastData && this.lastData != requestBoards.data && this.lastData.length < requestBoards.data) {
                        let data = [] as any;
            ...
            if (this.state === false)
                ...
                try {
                    ...
                    if (this.lastData && this.lastData != requestBoards.data) {
                        ...
                        for (const f of data) {
                            this.reaction.params.response = 'Your trello custom backgrounds changed, have a look ! id: ' + f.id;
